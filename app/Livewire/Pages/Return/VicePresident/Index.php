...
namespace App\Livewire\Pages\Return\VicePresident;
...
class Index extends Component
{
    ...
    public function approveTransactions(array $data)
    {
        ...
        $transaction->status = 'vice_approved';
        $transaction->save();
        flash()->success('Transaksi berhasil disetujui.');

        return $this->redirect(url: route('transactions.vice.president.index'), navigate: true);
    }
    ...
    public function rejectedInTable(array $data)
    {
        ...
        if (!$this->transaction) {
            ...
            return redirect()->route('transactions.vice.president.index');
        }
        ...
        return $this->redirect(route('transactions.vice.president.index'), navigate: true);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.pages.return.vice-president.index', [
