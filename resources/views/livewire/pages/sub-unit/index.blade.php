        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 shadow-sm sticky top-0 z-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <a href="{{ route('sub-units.index') }}" wire:navigate>
                        <h1 class="text-2xl font-bold text-gray-900 mb-4 sm:mb-0">Manajemen Sub Unit</h1>
                    </a>
                    <a href="{{ route('sub-units.create') }}" wire:navigate class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium
                                        ...
                                        @forelse ($subUnits as $subUnit)
                                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <!-- <div
                                                            ...
                                                            <span
                                                                class="text-gray-600 font-medium">{{ substr($subUnit->nama_sub_unit, 0, 1) }}</span>
                                                        </div> -->
                                                        <div class="ml-4">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('sub-units.edit', $subUnit->id_sub_unit) }}" wire:navigate
                                                    ...
                                                    <a wire:click="deleteConfirmation({{ $subUnit->id_sub_unit }})"
                                ...
                                <div class="p-4 border-b border-gray-200">
                                    <div class="flex items-center justify-between mb-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <div class="text-sm font-medium text-gray-900">{{ $subUnit->nama_sub_unit }}</div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="px-4 py-3 bg-white border-t border-gray-200 sm:px-6">
                            <div class="flex items-center justify-between flex-col sm:flex-row gap-4">
                                <div class="text-sm text-gray-700">
                                    Showing
                                    <span class="font-medium">{{ $subUnits->firstItem() ?? 0 }}</span>
                                    to
                                    <span class="font-medium">{{ $subUnits->lastItem() ?? 0 }}</span>
                                    of
                                    <span class="font-medium">{{ $subUnits->total() }}</span>
                                    results
                                </div>
                                <div>
                                    {{ $subUnits->links() }}
