    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        @enderror" placeholder="Masukan nama pengguna">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="w-full max-w-sm min-w-[200px]">
                                            <select wire:model="role" id="role" class="w-full bg-transparent text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow
                                                @error('role') 
                                                ...
                                                @forelse ($roles as $role)
                                                    <option value="{{ $role->name }}" {{ $this->userRole == $role->name ? 'selected' : '' }}>
                                                        {{ ucfirst($role->name) }}
                                                    </option>
                                                @empty
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="w-full max-w-sm min-w-[200px]">
                                            <select wire:model="status" id="status" class="w-full bg-transparent text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow
                                                @error('status') 
                                                    border-red-300 text-red-900 focus:border-red-500
                                                @enderror">
                                    ...
                                    <div class="sm:col-span-3" x-data="{}"
                                        x-show="$wire.role !== 'asman' && $wire.role !== 'superadmin'">
                                        <label for="status" class="block text-sm font-medium text-gray-700">Sub
                                            Unit</label>
                                        <div class="w-full max-w-sm min-w-[200px]">
                                            <select wire:model="id_sub_unit" id="id_sub_unit" class="w-full bg-transparent text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow
                                                @error('id_sub_unit') 
                                                    border-red-300 text-red-900 focus:border-red-500
                                                @enderror">
                                                <option value="" disabled>Pilih Sub Unit</option>
                                                @forelse ($subUnits as $subUnit)
                                                    <option value="{{ $subUnit->id_sub_unit }}" {{ $this->id_sub_unit == $subUnit->id_sub_unit ? 'selected' : '' }}>
                                    ...
                                    <div class="sm:col-span-3" x-data="{}" x-show="$wire.role === 'asman'">
                                        ...
                                        <div class="w-full max-w-sm min-w-[200px]">
                                            <select wire:model="admin_id" id="admin_id" class="w-full bg-transparent text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow
                                                @error('admin_id') 
                                                    border-red-300 text-red-900 focus:border-red-500
                                                @enderror">
