            ...
            <header class="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 shadow-sm sticky top-0 z-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center">
                        <a href="{{ route('transactions.manager.index') }}" wire:navigate class="mr-2">
                ...
                <div class="bg-white rounded-lg shadow-md mb-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="px-3 py-1 rounded-full text-sm font-medium
                                            ...
                                            @elseif($this->transaction->status === 'manager_approved') bg-blue-100 text-blue-800
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-4">
                        @if($this->transaction->status === 'pending')
                            ...
                            <button type="button"
                                wire:click="approveConfirmation('{{ ($this->transaction->id_transactions) }}')"
                                class="px-4 py-2 bg-green-500 border border-transparent rounded-md font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Approve
                            </button>
                        @elseif($this->transaction->status === 'manager_approved')
